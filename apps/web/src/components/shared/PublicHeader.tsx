            ...
            <div className="flex-1 flex items-center justify-end gap-6">
              ...
              <div className="flex items-center gap-2.5 pl-3 border-l border-gray-800">
                ...
                <a
                  ...
                  className="w-5 h-5 min-h-0 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-white transition-colors"
                >
        ...
        <div className="border-b border-[#E5E5E5] bg-white">
          <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 h-[60px] sm:h-[66px] flex items-center justify-between">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`transition-colors hover:text-[#050505] py-2 relative min-h-0 flex items-center justify-center ${
            ...
            <div className="hidden md:flex flex-1 items-center justify-end gap-5">
              <Link
                href="/login"
                className="text-[13.5px] font-semibold text-[#444444] hover:text-[#050505] transition-colors py-1.5 px-2.5 rounded hover:bg-[#F7F7F5] min-h-0 flex items-center justify-center"
              >
                Login
              </Link>
              <Link
