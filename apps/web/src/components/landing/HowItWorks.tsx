            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 relative">
              ...
              {steps.map((step) => {
                return (
                  <div
                    key={step.num}
                    className="relative z-10 bg-white sm:bg-transparent p-5 sm:p-2 rounded-xl sm:rounded-none border sm:border-0 border-[#E5E5E5] space-y-3"
                  >
                    {/* Circle Icon Badge */}
                    <div className="w-12 h-12 rounded-full bg-[#050505] text-white flex items-center justify-center font-heading font-black text-sm shadow-md">
